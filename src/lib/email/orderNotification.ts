  ...
  <div style="max-width:600px;margin:32px auto;background:#fff;border-radius:16px;border:1px solid #ece8e1;overflow:hidden">
    ...
    <div style="padding:32px">
      ...
      <table style="width:100%;border-collapse:collapse;margin-bottom:24px">
        ...
        <tfoot>
          <tr>
            <td colspan="3" style="padding:6px 12px;text-align:right;color:#8187a2">Ara toplam</td>
            <td style="padding:6px 12px;text-align:right">${subtotal.toLocaleString("tr-TR")} ₺</td>
            <td></td>
          </tr>
          <tr>
            <td colspan="3" style="padding:6px 12px;text-align:right;color:#8187a2">Kargo</td>
          ...
          <tr>
            ...
            <td style="padding:6px 12px;text-align:right;color:#2d6a4f;font-weight:600">−${discountAmount.toLocaleString("tr-TR")} ₺</td>
            <td></td>
          </tr>` : ""}
          <tr>
            <td colspan="3" style="padding:12px;text-align:right;font-weight:700;border-top:1px solid #ece8e1">Toplam</td>
            <td style="padding:12px;text-align:right;font-weight:700;color:#e07a5f;border-top:1px solid #ece8e1">${total.toLocaleString("tr-TR")} ₺</td>
